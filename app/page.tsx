...
export default function Home() {
    ...
    return (
        <main className="max-w-3xl mx-auto p-6 space-y-8">
            <h1 className="text-3xl font-bold">Bienvenue sur <span className="text-amber-700">CaféLog</span> !</h1>
                    ...
                    <CardContent>
                        {lastTest ? (
                            <div className="flex flex-col gap-2">
                                ...
                                {lastTest.comment && (
                                    <div className="italic text-xs text-gray-500">“{lastTest.comment}”</div>
                                )}
