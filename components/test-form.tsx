    ...
    return (
        <form className="max-w-2xl mx-auto space-y-8" onSubmit={handleSubmit}>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <SelectContent>
                                {coffees.map(coffee => (
                                    <SelectItem key={coffee.id} value={coffee.name}>{coffee.name}</SelectItem>
                                ))}
                            </SelectContent>
                        </Select>
                    </div>
                    <div>
                        ...
                        <Select
                            name="machine"
                            value={form.machine}
                            onValueChange={value => setForm(f => ({...f, machine: value}))}
                            required
                        >
                            <SelectTrigger className="w-full">
                    ...
                    <div>
                        ...
                        <Input name="beverageType" value={form.beverageType} onChange={handleChange} required
            ...
            <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <Input type="number" name="quantity" value={form.quantity} min={10} max={500}
                               onChange={handleChange} required/>
                    </div>
                    <div>
                        <label className="block mb-1 font-semibold">Température (°C)</label>
                        <Input type="number" name="temperature" value={form.temperature} min={60} max={100}
                               onChange={handleChange} required/>
                    </div>
                    <div>
                        <label className="block mb-1 font-semibold">Pression (bar)</label>
                        <Input type="number" name="pressure" value={form.pressure} min={1} max={15}
                               onChange={handleChange} required/>
                    </div>
                    <div>
                        <label className="block mb-1 font-semibold">Mouture</label>
                        <Input name="grindSize" value={form.grindSize} onChange={handleChange}
            ...
            <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <Slider min={1} max={5} step={1} value={[form.intensity]}
                    ...
                    <div>
                        ...
                        <Slider min={1} max={5} step={1} value={[form.bitterness]}
                    ...
                    <div>
                        ...
                        <Slider min={1} max={5} step={1} value={[form.acidity]}
            ...
            <div className="flex justify-end">
                <Button type="submit" size="lg" className="bg-amber-700 hover:bg-amber-800 text-white">Ajouter le
                    test</Button>
            </div>
        </form>
    );
